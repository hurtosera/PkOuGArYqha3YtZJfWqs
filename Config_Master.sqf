...
Config_911System = [
    ["Bomberos","Herido por quemaduras","BURNED_VICTIM",2],
    ["Bomberos","Edificio en llamas","BURNING_BUILDING",2],
    ["Bomberos","Apartamento en llamas","BURNING_APARTMENT",2],
    ["Bomnberos","Casa en llamas","HOUSE_FIRE",2],
    ["Bomberos","Fuego","FIRE",2],
    ["Bomberos","Explosión","EXPLOSION",2],
    ["Bomberos","Explosión de vehículo","VEHICLE_EXPLOSION",2],
    ["Bomberos","Vehículo en llamas","VEHICLE_FIRE",2],
    ["Bomberos","Incendio provocado","ARSON_ATTACK",2],
    ["Traffic Related","Accidente de tráfico","VEHICLE_ACCIDENT",2],
    ["Traffic Related","Saltarse semáforo","RED_LIGHT",2],
    ["Traffic Related","No lleva casco","NO_HELMET",2],
    ["Traffic Related","Conducción temeraria","RECKLESS_DRIVING",2],
    ["Traffic Related","Violación del tráfico","TRAFFIC_VIOLATION",2],
    ["Traffic Related","Exceso de velocidad","SPEEDING",2],
...
Config_NPC_Text = [
    ["mcfishers_initial","¡Buenas! Bienvenido a McFishers, ¿En que le puedo ayudar?",["1. ¡Buenas! Me gustaría trabajar en McFishers","2. Ignórame, Estaba de paso"],["if (player getVariable 'job' == 'mcfisher') exitwith {['mcfishers_already'] call A3PL_NPC_Start;}; ['mcfishers_work'] call A3PL_NPC_Start;",""]],
    ["mcfishers_work","¡Perfecto! Siempre estamos contratando gente. ¿Estás seguro de que quieres trabajar aquí? Tu contrato será de 1 mes (1 hora).",["1. Suena bien, ¡Empezaré cuanto antes!","2. Lo he pensado y he cambiado de opinión, de todas maneras gracias por la oferta."],["['mcfisher'] call A3PL_NPC_TakeJob;",""]],
    ["mcfishers_already","Ya estás trabajando aquí...",["1. ¡Estaba bromeando! *risas*","2. Me gustaría dejar de trabajar en este sitio, lo odio."],["","[] call A3PL_NPC_LeaveJob;"]],["mcfishers_accepted","Ahora eres trabajar a jornada completo.Puedes encontrar tu uniforme de trabajo en la taquilla.¿Tengo que explicarte como funciona esto?",["1. Si por favor.","2. He hecho este tipo de trabajo antes. ¡Soy bueno!"],["['mcfishers_tutorial'] call A3PL_NPC_Start;",""]],
    ["mcfishers_tutorial","De acuerdo, escucha. 1. Encontrarás los ingredientes en la cocina. 2. Usa la parrilla para cocinar las hamburguesas. 3. El micrófono se utiliza para hablar con los clientes.",["1. De acuerdo, ¡lo tengo!"],[""]],
    ["tacohell_initial","Buenas! Bienvenido al Taco Hell, ¿en que te puedo ayudar?",["1. ¡Buenas! Me gustaría empezar a trabajar en el Taco Hell","2. Ignórame, solo estaba dándome una vuelta"],["if (player getVariable 'job' == 'tacohell') exitwith {['tacohell_already'] call A3PL_NPC_Start;}; ['tacohell_work'] call A3PL_NPC_Start;",""]],
    ["tacohell_work","¡Perfecto! Siempre estamos contratando gente. ¿Estás seguro de que quieres trabajar aquí? Tu contrato será de 1 mes (1 hora).",["1. Suena bien, ¡Empezaré cuanto antes!","2. Me lo he pensado y he cambiado de opinión, de todas maneras gracias por la oferta."],["['tacohell'] call A3PL_NPC_TakeJob;",""]],
    ["tacohell_already","Ya estás trabajando aquí...",["1. ¡Estaba bromeando! *risas*","2. Me gustaría dejar de trabajar aquí, Odio este sitio."],["","[] call A3PL_NPC_LeaveJob;"]],
    ["tacohell_accepted","Ahoras eres empleado a tiempo completo. Encontrarás el uniforme de trabajo en la taquilla. ¿Tengo que explicarte lo básico?",["1. Si por favor.","2. He hecho este tipo de trabajo antes. ¡Soy bueno!"],["['tacohell_tutorial'] call A3PL_NPC_Start;",""]],
    ["tacohell_tutorial","De acuerdo, escucha. 1. Encontrarás los ingredientes en la cocina. 2. Utiliza la parrilla para cocinar el pescado. 3. El micrófono es utilizado para hablar con los clientes.",["1. De acuerdo, ¡lo tengo!"],[""]],
    ["fisherman_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. ¡Buenas! ¡Me gustaría ser pescador!","2. Solo estaba dándome una vuelta, no me hagas caso.","3. Me gustaría acceder a la tienda"],["if (player getVariable 'job' == 'fisherman') exitwith {['fisherman_already'] call A3PL_NPC_Start;}; ['fisherman_work'] call A3PL_NPC_Start;","","['Shop_Fisherman'] call A3PL_Shop_open"]],
    ["fisherman_work","Fishers island siempre está buscando pescadores. McFishers tiene que conseguir el pescado de algún lado  *risas* ¿Estás seguro de que quieres ser pescador?",["1. Si, prepárame la caña!","2. Por ahora, No quiero ser pescador."],["['fisherman'] call A3PL_NPC_TakeJob;",""]],
    ["fisherman_already","Estás trabajando de pescador...",["1. ¡Estaba bromeando! *risas*","2. Me gustaría dejar de trabajar aquí, no me gusta la pesca"],["","[] call A3PL_NPC_LeaveJob;"]],
    ["fisherman_accepted","¡Ahora eres pescador! ¿Tengo que explicarte lo básico?",["1. Si por favor.","2. He hecho este tipo de trabajo antes. ¡Soy bueno!"],["['fisherman_tutorial'] call A3PL_NPC_Start;",""]],
    ["fisherman_tutorial","De acuerdo, escucha atentamente. 1. Compra una red y un cubo de mi tienda. 2. Despliega la red cuando estés en el agua. 3. Espera un rato, después pliega la red",["1. De acuerdo, ¡lo tengo!"],[""]],
    ["bank_initial","Bienvenido al Banco de SkyCity. ¿En qué te puedo ayudar?",["1. Me gustaría firmar mi nómina","2. Me gustaría comprobar mi cuenta bancaria"],["if (Player_Paycheck < 1 ) then {['bank_paycheckrefuse'] call A3PL_NPC_Start;} else {['bank_paycheckaccepted'] call A3PL_NPC_Start;};","[] call A3PL_ATM_Open;"]],
    ["bank_paycheckrefuse","No parece que tengas que firmar tu nómina.",["1. De acuerdo. Volveré más tarde."],[""]],
    ["bank_paycheckaccepted","He encontrado tu nómina. Por favor, fírmala y asegúrate de abonar el importe indicado en tu cuenta bancaria.",["1. *firmar nómina* Ahí lo tienes, buen día.","2. Firmaré mi nómina más tarde."],["[] call A3PL_Player_PickupPaycheck;",""]],
    ["police_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. ¿Cómo me inscribo a la oficina del Sheriff?","2. Tengo un delito que notificar.","3. Entrar de servicio."],["['police_howto'] call A3PL_NPC_Start;","['police_reportcrime'] call A3PL_NPC_Start;","if (player getVariable 'job' == 'police') exitwith {['police_already'] call A3PL_NPC_Start;}; if (player getVariable 'faction' == 'police') then { ['police_work'] call A3PL_NPC_Start; } else {['police_workdenied'] call A3PL_NPC_Start;};"]],
    ["police_howto","Puedes encontrar más información en nuestra web.",["1. De acuerdo, gracias."],[""]],
    ["police_reportcrime","Puedes alertar de un delito llamando al 911.",["1. De acuerdo, gracias."],[""]],
    ["police_workdenied","No parece que trabajes aquí. Hacerte pasar por policía es delito.",["1. Lo siento, ya me voy."],[""]],
    ["police_work","¡Bienvenido de vuelta, Sheriff! ¿Seguro que quieres entrar de Servicio?",["1. Estoy listo, vamos a cazar criminales.","2. Déjame coger algunos donuts y estoy de vuelta."],["['police'] call A3PL_NPC_TakeJob;",""]],
    ["police_already","Ya estás de servicio. ¿Quieres salir de servicio?",["1. Sí, iré a mi casa.","2. Olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["police_accepted","Has entrado de servicio. Esta es tu radio y no te olvides de equiparte.",["1. Gracias, nos vemos más tarde."],[""]],
    ["dispatch_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. ¿Cómo me inscribo a la oficina del Sheriff?","2. Tengo un delito que notificar.","3. Entrar de servicio."],["['dispatch_howto'] call A3PL_NPC_Start;","['police_reportcrime'] call A3PL_NPC_Start;","if (player getVariable 'job' == 'dispatch') exitwith {['dispatch_already'] call A3PL_NPC_Start;}; if (!((player getVariable ['faction','citizen']) IN ['police','dispatch','ems','uscg','faa'])) exitwith {['dispatch_workdenied'] call A3PL_NPC_Start;}; ['dispatch_work'] call A3PL_NPC_Start; "]],
    ["dispatch_howto","Puedes encontrar más información en nuestra web.",["1. De acuerdo, gracias."],[""]],
    ["dispatch_workdenied","No parece que trabajes aquí.",["1. Lo siento, ya me voy."],[""]],
    ["dispatch_work","¡Bienvenido de vuelta, Sheriff! ¿Seguro que quieres entrar de Servicio?",["1. Estoy listo.","2. Déjame coger algunos donuts y estoy de vuelta."],["['dispatch'] call A3PL_NPC_TakeJob;",""]],
    ["dispatch_already","Ya estás de servicio. ¿Quieres salir de servicio?",["1. Sí, iré a mi casa.","2. Olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["dispatch_accepted","Has entrado de servicio. Preparate para responder a las llamdas del 911. Buena suerte.",["1. Gracias, nos vemos."],[""]],
    ["uscg_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. Entrar de Servicio."],["if (player getVariable 'job' == 'uscg') exitwith {['uscg_already'] call A3PL_NPC_Start;}; if (player getVariable 'faction' == 'uscg') then { ['uscg_work'] call A3PL_NPC_Start; } else {['uscg_workdenied'] call A3PL_NPC_Start;};"]],
    ["uscg_workdenied","No parece que trabajes aquí.",["1. Lo siento, ya me voy."],[""]],
    ["uscg_work","¡Bienvenido de vuelta, Guardacostas! ¿Seguro que quieres entrar de Servicio?",["1. Estoy listo.","2. Olvídalo."],["['uscg'] call A3PL_NPC_TakeJob;",""]],
    ["uscg_already","Ya estás de servicio. ¿Quieres salir de servicio?",["1. Sí, iré a mi casa.","2. Olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["uscg_accepted","Has entrado de servicio. Esta es tu radio y no te olvides de equiparte.",["1. Gracias, nos vemos."],[""]],
    ["fifr_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. No me encuentro muy bien, ¿puedes revisarme?","2. ¿Cómo ingreso al cuerpo?","3. Entrar de Servicio."],["if ((str (player getvariable ['A3PL_Wounds',[]]) == '[]') OR ((player getvariable ['A3PL_MedicalVars',[5000]] select 0) == 5000)) exitwith {['fifr_healdenied'] call A3PL_NPC_Start;}; ['fifr_heal'] call A3PL_NPC_Start;","['fifr_howto'] call A3PL_NPC_Start;","if (player getVariable 'job' == 'fifr') exitwith {['fifr_already'] call A3PL_NPC_Start;}; if (player getVariable 'faction' == 'fifr') then { ['fifr_work'] call A3PL_NPC_Start; } else {['fifr_workdenied'] call A3PL_NPC_Start;};"]],
    ["fifr_healdenied","Pareces estar bien, no necesitas asistencia médica.",["1. De acuerdo, gracias de todos modos."],[""]],
    ["fifr_howto","Puedes encontrar más información en nuestra web.",["1. De acuerdo, gracias."],[""]],
    ["fifr_workdenied","No parece que trabajes aquí.",["1. Lo siento, ya me voy"],[""]],
    ["fifr_work","¡Bienvenido de vuelta! ¿Seguro que quieres entrar de Servicio?",["1. Entrar de Servicio.","2. Todavía no."],["['fifr'] call A3PL_NPC_TakeJob;",""]],
    ["fifr_already","Ya estás de servicio. ¿Quieres salir de servicio?",["1. Sí, iré a mi casa.","2. Olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["fifr_accepted","Has entrado de servicio. Esta es tu radio y no te olvides de equiparte.",["1. Gracias, nos vemos."],[""]],
    ["fifr_heal","Te echaremos un vistazo, pero necesitaremos 100$, ¿estás seguro de que quieres pagar?",["1. Sí, no me siento muy bien.","2. Es demasiado, lo siento."],["[] call A3PL_Medical_Heal;",""]],
    ["fifr_healdone","Estos medicamentos te sentarán bien.",["1. De acuerdo, gracias."],[""]],
    ["roadworker_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. ¡Hola! Me gustaria trabajar en el servicio de manutención de carreteras.","2. Nada, adiós."],["if ((player getVariable ['job','unemployed']) == 'roadworker') exitwith {['roadworker_already'] call A3PL_NPC_Start;}; ['roadworker_work'] call A3PL_NPC_Start;",""]],
    ["roadworker_work","Claro, siempre estamos dispuestos a ayudar a la gente. ¿Estás seguro de que quieres trabajar?",["1. Sí, estoy seguro.","2. No, gracias."],["['roadworker'] call A3PL_NPC_TakeJob;",""]],
    ["roadworker_already","Estás trabajando en el servicio de manutención de carreteras. ¿Quieres salir de servicio?",["1. Sí, me gustaría dejar de trabajar aquí.","2. No, olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["roadworker_accepted","Eres un trabajador del servicio de carreteras. ¿Quieres que te explique lo básico?",["1. Sí porfavor.","2. No, soy bueno en esto."],["['roadworker_howto'] call A3PL_NPC_Start;",""]],
    ["roadworker_howto","De acuerdo, es muy fácil. 1. Recibirás un mensaje con los coches que debes incautar, usa el mapa para ver donde. 2. Retira los vehículos y gana tu recompensa.",["1. De acuerdo, gracias."],[""]],
    ["farmer_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. Hola, me gustaría iniciarme como granjero.","2. Nada, adiós."],["if ((player getVariable ['job','unemployed']) == 'farmer') exitwith {['farmer_already'] call A3PL_NPC_Start;}; ['farmer_work'] call A3PL_NPC_Start;",""]],
    ["farmer_work","Claro, siempre estamos dispuestos a ayudar a la gente. ¿Estás seguro de que quieres trabajar como granjero?",["1. Sí, estoy seguro.","2. No, gracias."],["['farmer'] call A3PL_NPC_TakeJob;",""]],
    ["farmer_already","Estás trabajando en el servicio de manutención de carreteras. ¿Quieres dejar el trabajo?",["1. Sí, me gustaría dejar de trabajar aquí.","2. Olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["farmer_accepted","Eres un trabajador del servicio de carreteras. ¿Quieres que te explique lo básico?",["1. Sí, por favor.","2. No, soy bueno en esto."],["['farmer_howto'] call A3PL_NPC_Start;",""]],
    ["farmer_howto","De acuerdo, es muy fácil. 1. Busca semillas en esta parcela. 2. Planta esas semillas en la parcela. 3. Cultiva y véndelas para obtener beneficios.",["1. De acuerdo, gracias."],[""]],
    ["oil_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. Hey, me gustaría trabajar como petrolero y usar la bomba de extracción.","2. Nada, adiós"],["if ((player getVariable ['job','unemployed']) == 'oil') exitwith {['oil_already'] call A3PL_NPC_Start;}; ['oil_work'] call A3PL_NPC_Start;",""]],
    ["oil_work","¡Claro! ¿Estás seguro que quieres ser extractor de petróleo?",["Sí, estoy seguro.","No, olvídalo."],["['oil'] call A3PL_NPC_TakeJob;",""]],
    ["oil_already","Ya estás trabajando como petrolero. ¿Quieres dejar de trabajar aquí?",["1. Sí, me gustaría dejar de trabajar aquí.","2. No, olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["oil_accepted","Ahora eres petrolero. ¿Quieres que te explique lo básico?",["1. Sí por favor.","2. No, estoy bien"],["['oil_howto'] call A3PL_NPC_Start;",""]],
    ["oil_howto","De acuerdo. 1. Busca un área para extraer petróleo. 2. Usa la bomba de extracción para extraer el petróleo. 3. Conecta la bomba y comienza a extraer.",["1. De acuerdo, gracias."],[""]],
    ["wildcat_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. ¡Hola! Me gustaría extraer petróleo.","2. Nada, adiós"],["if ((player getVariable ['job','unemployed']) == 'wildcat') exitwith {['wildcat_already'] call A3PL_NPC_Start;}; ['wildcat_work'] call A3PL_NPC_Start;",""]],
    ["wildcat_work","Claro, podemos ayudarte pero, ¿estás seguro?",["1. Sí, estoy seguro.","2. No, olvídalo."],["['wildcat'] call A3PL_NPC_TakeJob;",""]],
    ["wildcat_already","Ya estás trabajando como petrolero. ¿Quieres dejar de trabajar aquí?",["1. Sí, me gustaría dejar de trabajar aquí.","2. No, olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["wildcat_accepted","Ahora eres un petrolero. ¿Quieres que te explique lo básico?",["1. Sí por favor.","2. No, estoy bien."],["['wildcat_howto'] call A3PL_NPC_Start;",""]],
    ["wildcat_howto","De acuerdo. 1. Crea un taladro y acóplalo a tu vehículo. 2. Excava la zona en busca de recursos. 3. Despues puedes conectar la bomba y extraer.",["1. Alright, thank you."],[""]],
    ["faastart_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. ¡Hola! ¿Cómo trabajo aquí?","2. Me gustaría entrar a trabajar como ATC"],["['faastart_howto'] call A3PL_NPC_Start;","if (player getVariable 'job' == 'faa') exitwith {['faastart_already'] call A3PL_NPC_Start;}; if (player getVariable 'faction' IN ['faa','uscg']) then { ['faastart_work'] call A3PL_NPC_Start; } else {['faastart_workdenied'] call A3PL_NPC_Start;}"]],
    ["faastart_howto","Puedes encontrar más información en nuestra web.",["1. De acuerdo, gracias."],["1. De acuerdo, gracias."]],
    ["faastart_already","Ya estás trabajando como FAA, ¿quieres dejar de trabajar aquí?",["1. Me gustaría dejar de trabajar aquí.","2. No, olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["faastart_work","¡Bienvenido de vuelta! ¿Seguro que quieres entrar de Servicio?",["1. Estoy listo.","2. Volveré más tarde."],["['faa'] call A3PL_NPC_TakeJob;",""]],
    ["faastart_workdenied","No parece que trabajes aquí.",["1. Lo siento, ya me voy."],[""]],
    ["government_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. ¡Hola! ¿Cómo trabajo aquí?","2. ¡Hola! Me gustaría entrar a trabajar."],["['government_howto'] call A3PL_NPC_Start;","if (player getVariable 'job' == 'gov') exitwith {['government_already'] call A3PL_NPC_Start;}; if (player getVariable 'faction' == 'gov') then { ['government_work'] call A3PL_NPC_Start; } else {['government_workdenied'] call A3PL_NPC_Start;}"]],
    ["government_howto","Puedes encontrar más información en nuestra web.",["1. De acuerdo, gracias."],[""]],
    ["government_already","Estás trabajando como empleado del gobierno. ¿Quieres dejar de trabajar?",["1. Sí, me gustaría dejar de trabajar aquí.","2. No, olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["government_work","¡Bienvenido de vuelta! ¿Seguro que quieres entrar de Servicio?",["1. Estoy listo.","2. No, volveré más tarde."],["['gov'] call A3PL_NPC_TakeJob;",""]],
    ["government_workdenied","No parece que trabajes aquí.",["1. Lo siento, ya me voy."],[""]],
    ["doj_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. ¡Hola! ¿Cómo trabajo aquí?","2. Entrar de Servicio."],["['doj_howto'] call A3PL_NPC_Start;","if (player getVariable 'job' == 'doj') exitwith {['doj_already'] call A3PL_NPC_Start;}; if (player getVariable 'faction' == 'doj') then { ['doj_work'] call A3PL_NPC_Start; } else {['doj_workdenied'] call A3PL_NPC_Start;}"]],
    ["doj_howto","Puedes encontrar más información en nuestra web.",["1. De acuerdo, gracias."],[""]],
    ["doj_already","Ya estás trabajando aquí. ¿Quieres dejar el trabajo?",["1. Me gustaría dejar de trabajar aquí.","2. No, olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["doj_work","Bienvenido de vuelta! ¿Seguro que quieres entrar de Servicio?",["1. Estoy listo.","2. No, volveré más tarde."],["['doj'] call A3PL_NPC_TakeJob;",""]],
    ["doj_workdenied","No parece que trabajes aquí.",["1. Lo siento, me iré."],[""]],
    ["dmv_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. ¡Hola! ¿Cómo trabajo aquí?","2. Me gustaría trabajar como DMV."],["['dmv_howto'] call A3PL_NPC_Start;","if (player getVariable 'job' == 'dmv') exitwith {['dmv_already'] call A3PL_NPC_Start;}; if (player getVariable 'faction' == 'dmv') then { ['dmv_work'] call A3PL_NPC_Start; } else {['dmv_workdenied'] call A3PL_NPC_Start;}"]],
    ["dmv_howto","Puedes encontrar más información en nuestra web.",["1. De acuerdo, gracias."],[""]],
    ["dmv_already","Estás trabajando como DMV. ¿Quieres dejar el trabajo?",["1. Sí, quiero dejar el trabajo.","2. No, olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["dmv_work","¡Bienvenido de vuelta! ¿Seguro que quieres entrar de Servicio?",["1. Estoy listo.","2. No, volveré más tarde."],["['dmv'] call A3PL_NPC_TakeJob;",""]],
    ["dmv_workdenied","No parece que trabajes aquí.",["1. Lo siento, ya me voy."],[""]],
    ["doc_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. ¡Hola! ¿Cómo puedo trabajar aquí?","2. Entrar de Servicio."],["['doc_howto'] call A3PL_NPC_Start;","if (player getVariable 'job' == 'doc') exitwith {['doc_already'] call A3PL_NPC_Start;}; if (player getVariable 'faction' == 'doc') then { ['doc_work'] call A3PL_NPC_Start; } else {['doc_workdenied'] call A3PL_NPC_Start;}"]],
    ["doc_howto","Puedes encontrar más información en nuestra web.",["1. De acuerdo, gracias."],[""]],
    ["doc_already","Ya estás trabajando como DOC. ¿Seguro que quieres salir de servicio?",["1. Sí, me gustaría salir de servicio.","2. No, olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["doc_work","¡Bienvenido de vuelta! ¿Seguro que quieres entrar de Servicio?",["1. Estoy listo.","2. No, volveré más tarde."],["['doc'] call A3PL_NPC_TakeJob;",""]],
    ["doc_workdenied","No parece que trabajes aquí.",["1. Lo siento, adiós."],[""]],
    ["faastop_initial","¡Buenas! ¿En qué te puedo ayudar?",["1. Me gustaría dejar el trabajo de ATC."],["[] call A3PL_ATC_LeaveJob;"]],
    ["roadside_service_initial","¿Quieres trabajar como gruista?",["Claro, ¿de cuánto es el sueldo?","No, necesito algunos items.","No, gracias."],["if ((player getVariable ['job','unemployed']) == 'Roadside_Service') exitwith {['roadside_service_already'] call A3PL_NPC_Start;}; ['roadside_service_work'] call A3PL_NPC_Start;","if ((player getVariable ['job','unemployed']) == 'Roadside_Service') exitwith {['roadside_service_supplies'] call A3PL_Shop_Open;};",""]],
    ["roadside_service_work","Recibirás $400 por cada pago y $2500 por incautación.",["De acuerdo, ¿dónde empiezo?","No, olvídalo."],["['Roadside_Service'] call A3PL_NPC_TakeJob;['roadside_service_accepted'] call A3PL_NPC_Start;",""]],
    ["roadside_service_already","Ya estás trabajando para nosotros. ¿Quieres parar de trabajar aquí?",["Sí, me gustaría dejar de trabajar aquí.","No, olvídalo."],["[] call A3PL_NPC_LeaveJob;",""]],
    ["roadside_service_accepted","Ahora eres gruista. ¿Necesitas que te explique lo básico?",["No, soy bueno.","Sí, por favor"],["","['roadside_service_howto'] call A3PL_NPC_Start;"]],
    ["roadside_service_howto","Tienes dos trabajos: 1. Proveer asistencia en carretera. 2. Incautar vehiculos...",["Continuar","De acuerdo, gracias."],["['roadside_service_howtopt2'] call A3PL_NPC_Start;",""]],
    ["roadside_service_howtopt2","Asistencia proveída: Necesitarás una llave y latas de combustible. Puedes encontrarlas en la Tienda General.",["Continuar","De acuerdo, gracias."],["['roadside_service_howtopt3'] call A3PL_NPC_Start;",""]],
    ["roadside_service_howtopt3","Si el vehículo está muy dañado deberá ser llevado con grúa al taller o a una gasolinera para repostarlo.",["Continuar","De acuerdo, gracias."],["['roadside_service_howtopt4'] call A3PL_NPC_Start;",""]],
    ["roadside_service_howtopt4","Vehículos Incautados: Recibirás un mensaje con los vehículos marcados para incautar. Usa el mapa para verlos.",["Continue","De acuerdo, gracias."],["['roadside_service_howtopt5'] call A3PL_NPC_Start;",""]],
    ["roadside_service_howtopt5","Una vez que hayas traido este vehículo con la grúa incáutalo y obten tu recompensa.",["De acuerdo, gracias."],[""]]
];
