...
Config_NPC_Text = [
    ...
    ["bank_initial","Bienvenido al Banco Of Freedom. ¿En que te puedo ayudar?",["1. I would like to sign my paycheck","2. I would like to check my bank account"],["if (Player_Paycheck < 1 ) then {['bank_paycheckrefuse'] call A3PL_NPC_Start;} else {['bank_paycheckaccepted'] call A3PL_NPC_Start;};","[] call A3PL_ATM_Open;"]],
